...
- Files listing context menu is a `GtkMenuButton` overlay on the Files pane (same popover host as toolbar menus), moved to the click and opened after the pointer click finishes

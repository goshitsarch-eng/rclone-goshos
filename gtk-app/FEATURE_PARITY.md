...
- Files listing context menu is a scrolled `GtkBox` (max height 420) hosted on the toolbar Selection actions `GtkMenuButton` so the full item list can present
